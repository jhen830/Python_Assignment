...
Please enter your option: """))
                ...
                if place_or_add == str(1):
                    ...
                    with open("purchase_order_list.txt", "a") as o:
                        o.write(f"\n{orderID},{cus_username},{datetime.date.today()},{cart},{total_price},unpaid")
...
def collect_order(cus_username):
    ...
    with open("customer_system_usage.txt", "a") as csu:
        csu.write(f"\n{cus_username},{action},{datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S')}")
                    ...
                    with open("purchase_order_list.txt", "r") as p:
                        ...
                        for line in lines:
                            ...
                            if cancel_order == p_order_id:
                                ...
                                p_updated_line = p_updated_line.replace(p_order_time,datetime.datetime.today().strftime("%Y-%m-%d %H:%M:%S"))
...
""")
    ...
    if ope == "1":
        ...
        customer_login = customer_login(cus_username,cus_password)
...
9. Log Out""")
            ...
            try:
                ...
                if customer_ope < 1 or customer_ope > 8:
                    print("Please enter a number between 1 and 8.")
                    time.sleep(1.5)
